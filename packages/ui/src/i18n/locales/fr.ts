export default {
  ...
  areaExport: {
    ariaLabel: "Exporter la zone",
    start: "Exporter la zone",
    cancel: "Annuler",
    panelAriaLabel: "Paramètres d'export de zone",
    panelTitle: "Export de zone",
    close: "Fermer",
    scaleLabel: "Échelle",
    customScale: "Personnalisée…",
  ...
  placemarkEditor: {
    ...
    radius: "Rayon",
    showDistanceRings: "Afficher les cercles de distance",
    ringSpacing: "Espacement des cercles",
    discRadius: "Rayon du disque",
